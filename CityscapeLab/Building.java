...
public class Building
{
    ...
    public void draw(Graphics2D g2)
    {
        ...
        //creates the first row of windows (for the main building)
        ...
        //creates the second row of windows (for the main building)
        ...
        //creates the third row of windows (for the main building)
        ...
        //creates the fourth row of windows (for the main building)
        ...
        //creates the fifth row of windows (for the main building)
        ...
        //creates the sixth row of windows (for the main building)
        ...
        //draws the first row of windows (for the main building)
        g2.draw(window11);
        g2.draw(window12);
        g2.draw(window13);
        g2.draw(window14);
        
        //draws the second row of windows (for the main building)
        g2.draw(window21);
        g2.draw(window22);
        g2.draw(window23);
        g2.draw(window24);
        
        //draws the third row of windows (for the main building)
        g2.draw(window31);
        g2.draw(window32);
        g2.draw(window33);
        g2.draw(window34);
        
        //draws the fourth row of windows (for the main building)
        g2.draw(window41);
        g2.draw(window42);
        g2.draw(window43);
        g2.draw(window44);
        
        //draws the fifth row of windows (for the main building)
        g2.draw(window51);
        g2.draw(window52);
        g2.draw(window53);
        g2.draw(window54);
        
        //draws the sixth row of windows (for the main building)
        g2.draw(window61);
        g2.draw(window64);
        
        //draws the left and right doors (for the main building)
        g2.draw(door1);
        g2.draw(door2);
        
        //colors the main building
        g2.setColor(Color.BLACK);
        g2.fill(mainBuilding);
        
        //colors the first row of windows (for the main building)
        ...
        //colors the second row of windows (for the main building)
        ...
        //colors the third row of windows (for the main building)
        //color already set to white
        g2.fill(window31);
        g2.fill(window32);
        g2.fill(window33);
        ...
        //colors the fourth row of windows (for the main building)
        //color already set to white
        g2.fill(window41);
        g2.fill(window42);
        g2.fill(window43);
        ...
        //colors the fifth row of windows (for the main building)
        //color already set to white
        g2.fill(window51);
        g2.fill(window52);
        g2.fill(window53);
        ...
        //colors the sixth row of windows (for the main building)
        //color already set to white
        g2.fill(window61);
        g2.fill(window64);
        
        //colors the left and right doors (for the main building)
        //color already set to white
        g2.fill(door1);
        g2.fill(door2);
    }
